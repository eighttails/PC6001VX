...
. シェルにて `apt install build-essential cmake ninja-build libx11-dev mesa-common-dev libopengl-dev libsdl2-dev qtcreator qt6-base-dev qt6-multimedia-dev libavformat-dev libavcodec-dev libswscale-dev` を実行。 +
