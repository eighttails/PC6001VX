...
【既知の不具合、制約事項】
・ウィンドウ最大化時にモニタモード、スキャンライン切り替えなど、
　画面サイズが変わる遷移を行うと、画面がおかしくなります。
　Windows→ウィンドウのサイズが変わる
　Linux→ウィンドウサイズが変わらず、表示倍率だけ等倍になる
　Qt4で開発していた頃には発生しなかった不具合なので、
　Qt5のバグである確率が高く、しばらくこのままにします。
・ウィンドウモードでモニタモード、スキャンライン切り替えなど、
　画面サイズが変わる遷移を行うと、ウィンドウが画面右上に移動します。
　Windowsではこうしないとタイトルバーが画面外にはみ出した状態で
　ウィンドウが開いてしまうため、暫定的にこのような回避措置をとっています。
・起動するたびにシステムの音量を変えてしまうことがあります。
　Qt5の音量制御周りはまだあまり枯れていないようです。
・なぜかかなキー(PAUSE)の利きが悪いです。
