...
int main(int argc, char *argv[])
{
  ...
  const int combine[][2] = {
    {0x2477, 0x304b}, {0x2478, 0x304d}, {0x2479, 0x304f}, {0x247a, 0x3051},
    {0x247b, 0x3053}, {0x2577, 0x30ab}, {0x2578, 0x30ad}, {0x2579, 0x30af},
    {0x257a, 0x30b1}, {0x257b, 0x30b3}, {0x257c, 0x30bb}, {0x257d, 0x30c4},
    {0x257e, 0x30c8}, {0x2678, 0x31f7},
  };

  const int pc6001tbl[] = {
    0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, /* 00 */
    0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000,
    0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, /* 10 */
    0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000,
    0x3000, 0xff01, 0xff02, 0x201d, 0xff04, 0xff05, 0xff06, 0xff07, /* 20 */
    ...
    0x3000, 0x3002, 0x300c, 0x300d, 0x3001, 0x30fb, 0x3092, 0x3041, /* 80 */
    ...
    0x3000, 0x3002, 0x300c, 0x300d, 0x3001, 0x30fb, 0x2572, 0x2521, /* a0 */
  ...
  const int pc8001tbl[] = {
    ...
    0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000,
    0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, 0x3000, /* 10 */
    0x3000, 0x3000, 0x3000, 0x3000, 0x2192, 0x2190, 0x2191, 0x2193,
    0x3000, 0xff01, 0xff02, 0x201d, 0x2170, 0x2173, 0x2175, 0x2147, /* 20 */
    ...
    0xff48, 0xff49, 0xff4a, 0xff4b, 0xff4c, 0xff4d, 0xff4e, 0xff4f,
    0xff50, 0xff51, 0xff52, 0xff53, 0xff54, 0xff55, 0xff56, 0xff57, /* 70 */
    0xff58, 0xff59, 0xff5a, 0x2150, 0x2143, 0x2151, 0x2141, 0x2121,
    ...
    0x2121, 0x3002, 0x300c, 0x300d, 0x3001, 0x30fb, 0x2572, 0x2521, /* a0 */
    0x2523, 0x2525, 0x2527, 0x2529, 0x2563, 0x2565, 0x2567, 0x2543,
    0x213c, 0x2522, 0x2524, 0x2526, 0x2528, 0x252a, 0x252b, 0x252d, /* b0 */
    0x252f, 0x2531, 0x2533, 0x2535, 0x2537, 0x2539, 0x253b, 0x253d,
    0x253f, 0x2541, 0x2544, 0x2546, 0x2548, 0x254a, 0x254b, 0x254c, /* c0 */
  ...
  const int alttbl[][2] = {
    {0x17c, 0xff5c},
    {0x1e8, 0x25b2}, {0x1e9, 0x25bc}, {0x1e9, 0x25c6}, {0x1ea, 0x2605},
    {0x1ee, 0xff0f}, {0x1ef, 0xff3c}, {0x1f0, 0x00d7},
  };
  ...
  if (argc < opt + 2) {
    printf("usage: bdf2exkanji [-f] [-jisx0213] [-8 PC-8001.chr] fontfile.bdf outfile\n");
    exit(1);
  }
  ...
  if (DEBUG) {
    printf("pixel_x=%d, pixel_y=%d (ascent=%d, descent=%d)\n",
	   pixel_x, pixel_y, ascent, descent);
  }
  ...
  while (fgets(line, sizeof(line), fp)) {
	...
	if (charset == JIS && jisunitbl[i][0] == code) {
	  ...
	  chr = code;
	  break;
	} else if (charset == UNI && code == SEMIVOICED_MARK) {
	...
	offset_x = 0;
      ...
      if (DEBUG) {
	printf("chr=%x: ratio_x=%f, ratio_y=%f\n", chr, ratio_x, ratio_y);
      }
  ...
  for (i = 0x2120; i < NCHR; i++) {
	...
	if (i == combine[j][0]) {
	  ...
	  for (k = 0; k < 16; k++) {
	    bmp60_left[i][k] =
	      bmp60_left[combine[j][1]][k] | bmp60_left[SEMIVOICED_MARK][k];
	    bmp60_right[i][k] =
	      bmp60_right[combine[j][1]][k] | bmp60_right[SEMIVOICED_MARK][k];
	  }
	}
      }
    }
