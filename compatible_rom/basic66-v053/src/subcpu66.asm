;sub CPU (uPD8049) program for PC-6001mk2/6601
...
;jump table
CMDJMP:
	.db	INTEND, INTEND, INTEND, INTEND, CHGKANA, CHGKANA, QUERY, INTEND
...
;$04: alphanumeric <-> kana
;$05: hiragana <-> katakana
CHGKANA:
	add	a,-CMDJMP-3	;1 or 2
	mov	r0,KANA
	xrl	a,@r0
	mov	@r0,a
	cpl	a
...
CHKSPKEY:
	...
	mov	a,r2
	add	a,-$39
	jz	INT14		;$39: stop key
	add	a,$39-$40
	jz	INT14		;$40: kana key
	add	a,$40-$45
	jz	INT14		;$45: mode key
	dec	a
	jz	INT14		;$46: caps key
