...
const COLOR24 cConfig::STDColor[] = {	// 標準カラーデータ ( R,G,B,0  0-255 )
				...
				{ 225,  47,  32, 0 },	// 41:にじみ 赤(Set1)
				{ 242, 231,   9, 0 },	// 42:にじみ 黄(Set1)
				{   0,   0,   0, 0 },	// 43:にじみ - (Set1)
				{   0,   0,   0, 0 },	// 44:にじみ - (Set1)
				{ 255,  48,   0, 0 },	// 45:にじみ 赤(Set2)
				{ 120, 220, 255, 0 },	// 46:にじみ 青(Set2)
				{ 255,  72,  72, 0 },	// 47:にじみ 桃(Set2)
				{  40, 255,  80, 0 },	// 48:にじみ 緑(Set2)
				...
				{   0,   0,   0, 0 },	// 66:青っぽい黒
				{   0,   0,   0, 0 },	// 67:赤っぽい黒
				{ 255, 255, 255, 0 },	// 68:黒っぽい白
				{ 255, 255, 255, 0 },	// 69:青っぽい白
				{ 255, 255, 255, 0 },	// 70:赤っぽい白
				{ 120, 220, 255, 0 },	// 71:黒っぽい青
				{ 120, 220, 255, 0 },	// 72:白っぽい青
				{ 120, 220, 255, 0 },	// 73:赤っぽい青
				{ 255,  48, 255, 0 },	// 74:黒っぽい赤
				{ 255,  48, 255, 0 },	// 75:白っぽい赤
				{ 255,  48, 255, 0 }	// 76:青っぽい赤
			};
