...
const BYTE VDG62::COL62_CG[][8] = {		// mode 1-3 -----
                { 59,60,61,58, 0, 0, 0, 0 },
                { 64,63,62,50, 0, 0, 0, 0 },
                { 57,41,42,59, 0, 0, 0, 0 },	// mode1-4用
                { 57,45,46,64,65,66,67,68 },	// mode1-4用
                { 57,42,41,59, 0, 0, 0, 0 },	// mode1-4用
                { 57,46,45,64,67,68,65,66 },	// mode1-4用
                { 57,43,44,59, 0, 0, 0, 0 },	// mode1-4用
                { 57,47,48,64,69,70,71,72 },	// mode1-4用
                { 57,44,43,59, 0, 0, 0, 0 },	// mode1-4用
                { 57,48,47,64,71,72,69,70 }		// mode1-4用
			};
